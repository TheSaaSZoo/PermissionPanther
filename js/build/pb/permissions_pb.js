...
goog.exportSymbol('proto.PermissionGroupReq', null, global);
 ...
 * @constructor
 */
proto.PermissionGroupReq = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, proto.PermissionGroupReq.repeatedFields_, null);
};
goog.inherits(proto.PermissionGroupReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.PermissionGroupReq.displayName = 'proto.PermissionGroupReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.ModifyPermissionGroupReq = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, proto.ModifyPermissionGroupReq.repeatedFields_, null);
};
 ...
 * @const
 */
proto.PermissionGroupReq.repeatedFields_ = [4];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
     ...
     * @return {!Object}
     */
    proto.PermissionGroupReq.prototype.toObject = function (opt_includeInstance) {
        return proto.PermissionGroupReq.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Deprecated. Whether to include
     *     the JSPB instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.PermissionGroupReq} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.PermissionGroupReq.toObject = function (includeInstance, msg) {
        var f, obj = {
            keyid: jspb.Message.getFieldWithDefault(msg, 1, ""),
            keysecret: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PermissionGroupReq}
 */
proto.PermissionGroupReq.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.PermissionGroupReq;
    return proto.PermissionGroupReq.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PermissionGroupReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PermissionGroupReq}
 */
proto.PermissionGroupReq.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
 ...
 * @return {!Uint8Array}
 */
proto.PermissionGroupReq.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.PermissionGroupReq.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PermissionGroupReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PermissionGroupReq.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
    f = message.getKeyid();
    if (f.length > 0) {
        writer.writeString(1, f);
 ...
 * @return {string}
 */
proto.PermissionGroupReq.prototype.getKeyid = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/**
 * @param {string} value
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.setKeyid = function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
};
/**
 * optional string keySecret = 2;
 * @return {string}
 */
proto.PermissionGroupReq.prototype.getKeysecret = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
/**
 * @param {string} value
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.setKeysecret = function (value) {
    return jspb.Message.setProto3StringField(this, 2, value);
};
/**
 ...
 * @return {string}
 */
proto.PermissionGroupReq.prototype.getGroupname = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
/**
 * @param {string} value
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.setGroupname = function (value) {
    return jspb.Message.setProto3StringField(this, 3, value);
};
/**
 ...
 * @return {!Array<string>}
 */
proto.PermissionGroupReq.prototype.getPermissionsList = function () {
 ...
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.setPermissionsList = function (value) {
 ...
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.addPermissions = function (value, opt_index) {
 ...
 * @return {!proto.PermissionGroupReq} returns this
 */
proto.PermissionGroupReq.prototype.clearPermissionsList = function () {
 ...
 * @const
 */
proto.ModifyPermissionGroupReq.repeatedFields_ = [4];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
 ...
 * @return {!Array<string>}
 */
proto.ModifyPermissionGroupReq.prototype.getPermissionsList = function () {
    return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 4));
};
/**
 * @param {!Array<string>} value
 * @return {!proto.ModifyPermissionGroupReq} returns this
 */
proto.ModifyPermissionGroupReq.prototype.setPermissionsList = function (value) {
    return jspb.Message.setField(this, 4, value || []);
};
/**
 * @param {string} value
 ...
 * @return {!proto.ModifyPermissionGroupReq} returns this
 */
proto.ModifyPermissionGroupReq.prototype.addPermissions = function (value, opt_index) {
    return jspb.Message.addToRepeatedField(this, 4, value, opt_index);
};
/**
 * Clears the list making it empty but non-null.
 * @return {!proto.ModifyPermissionGroupReq} returns this
 */
proto.ModifyPermissionGroupReq.prototype.clearPermissionsList = function () {
    return this.setPermissionsList([]);
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ListPermissionGroupRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            membersList: jspb.Message.toObjectList(msg.getMembersList(), proto.PermissionGroupMembership.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.ListPermissionGroupRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.PermissionGroupMembership.serializeBinaryToWriter);
    }
};
/**
...
proto.ListPermissionGroupRes.prototype.getMembersList = function () {
    return /** @type{!Array<!proto.PermissionGroupMembership>} */ (jspb.Message.getRepeatedWrapperField(this, proto.PermissionGroupMembership, 2));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.PermissionGroupMembership.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            ns: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * @return {string}
 */
proto.PermissionGroupMembership.prototype.getNs = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
/**
 * @param {string} value
 * @return {!proto.PermissionGroupMembership} returns this
 */
proto.PermissionGroupMembership.prototype.setNs = function (value) {
    return jspb.Message.setProto3StringField(this, 3, value);
};
/**
